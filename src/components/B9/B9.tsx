export default function B9() {
  return (
    <div className="relative flex h-[calc(100vh-10rem)] w-full max-w-[20rem] flex-col rounded-xl bg-white bg-clip-border p-4 text-gray-700 shadow-xl shadow-blue-gray-900/5">
